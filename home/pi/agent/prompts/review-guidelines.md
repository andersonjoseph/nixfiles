---
description: Review code changes with structured findings, priority levels, and human callouts
---

Review the following: $@

If no target is specified, review uncommitted changes (`git diff`).
